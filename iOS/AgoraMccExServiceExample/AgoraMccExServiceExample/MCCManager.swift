...
class MCCManager: NSObject {
    ...
    func getLyric(songId: Int) -> String? {
        return mccExService.getLyric(songId, lyricType: .KRC)
    }
    
    func getPitch(songId: Int) -> String? {
        return mccExService.getPitch(songId)
    }
}
